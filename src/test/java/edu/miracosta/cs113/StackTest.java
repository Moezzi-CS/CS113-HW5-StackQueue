...
public class StackTest {
    ...
    public void testPushAndPeekOnce() {
        ...
        stack.push(5);
        assertEquals(
                5L, ((long) stack.peek()), "Expected and actual don't match, only one value was pushed!"); // 5L is a 5 but created as a long type literal
    }
    ...
    public void testPushAndPeekMany() {
        ...
        for (int i = 0; i < 5; i ++) {
            stack.push(i);
            assertEquals(((long) i), ((long) stack.peek()),"Expected and actual don't match, somethings wrong with pushing multiple values?"); // Cast expected and actual values as longs
        }
    }
    ...
    public void testPopOnce() {
        ...
        stack.push(71);
        assertEquals(
                71L, ((long) stack.pop()), "Expected and actual don't match- something's wrong with popping or pushing one value?"); // 71L is a 71 but created as a long type literal
    }
    ...
    public void testPopMany() {
        ...
        for (int i = 63; i >= 50; i --) {
            assertEquals(((long) i), ((long) stack.pop()), "Expected and actual don't match- something's wrong with popping or pushing multiple values?"); // Cast expected and actual values as longs
        }
    }
