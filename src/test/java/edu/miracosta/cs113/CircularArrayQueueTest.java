...
public class CircularArrayQueueTest {
    ...
    public void testPeekEmpty() {
        assertEquals(null, circularQueue.peek(),"Test peek failed - Call from an empty queue should return null.");
    }
    ...
    public void testOfferOne() {
        ...
        assertEquals(STRING_VALUES[0], circularQueue.peek(), "Test failed - Call to peek should return the head of this queue.");
        assertEquals(STRING_VALUES[0], circularQueue.element(), "Test failed - Call to element should return the head of this queue.");
    }
    ...
    public void testPollEmpty() {
        ...
        assertEquals(null, circularQueue.poll(), "Test poll failed - Call from an empty queue should return null.");
    }
    ...
    public void testPollOne() {
        ...
        assertEquals(STRING_VALUES[0], circularQueue.poll(), "Test poll failed - Call should return the head of the queue.");

        // Add and poll another element
        circularQueue.add(STRING_VALUES[1]);
        assertEquals(STRING_VALUES[1], circularQueue.poll(), "Test poll failed - Call should return the head of the queue.");
    }
    ...
    public void testPollFew() {
        ...
        for (int i = 0; i < INITIAL_CAPACITY; i ++) {
            assertEquals(STRING_VALUES[i], circularQueue.poll(), "Test poll failed - Call should return the head of the queue.");
        }
    }
    ...
    public void testRemoveOne() {
        ...
        circularQueue.offer(STRING_VALUES[0]);
        assertEquals(STRING_VALUES[0], circularQueue.remove(), "Test remove failed - Call should return the head of the queue.");

        // Add and remove another element
        circularQueue.add(STRING_VALUES[1]);
        assertEquals(STRING_VALUES[1], circularQueue.remove(), "Test remove failed - Call should return the head of the queue.");
    }
    ...
    public void testRemoveFew() {
        ...
        for (int i = 0; i < INITIAL_CAPACITY; i ++) {
            assertEquals(STRING_VALUES[i], circularQueue.remove(), "Test remove failed - Call should return the head of the queue.");
        }
    }
